...
def inspect_folder(directory):
    ...
    for root, dirs, files in os.walk(directory):
        ...
        for file in files:
            ...
            result.append({'name': file, 'parent': parent, 'type': 'file'})
        result.append({'name': os.path.basename(root), 'parent': os.path.basename(os.path.dirname(root)),
                       'type': 'directory', 'size': dir_size})
...
if __name__ == '__main__':
    inspect_folder(r'C:\Users\Enots\dz8')
